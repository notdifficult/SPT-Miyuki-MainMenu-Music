...
//======================================================================================================================//
    public class MusicPlayerMain : MonoBehaviour
    {
        ...
        private MusicPlayerUI _uiManager;
        public int CurrentTrackIndex => _currentTrackIndex;
        public TrackInfo[] Tracks => _tracks;
...
//======================================================================================================================//  
        private void Update()
        {
            ...
            {
                // Дешёвый вызов: просто обновляем текст
                _uiManager.UpdateStatus(_currentTrackIndex, _tracks);
            }
...
//======================================================================================================================//  
        private void PlayRandomFromCurrentFolder()
        {
            ...
            if (_uiManager != null)
            {
                _uiManager.TriggerNotification(); // Запускает таймер исчезновения
            }
...
//======================================================================================================================//       
        ...
        public void CreatePlayer(GameObject targetObject)
        {
            ...
            // Инициализация UI
            var uiObj = new GameObject("MusicPlayerUI_Holder");
            DontDestroyOnLoad(uiObj);
            _uiManager = uiObj.AddComponent<MusicPlayerUI>();
            _uiManager.Initialize();
    
            Debug.Log("[Miyuki] Player and UI initialized.");
        }
//======================================================================================================================//
...
//======================================================================================================================//
        ...
        private void PlayCurrentTrackByIndex(int index)
        {
            ...
            // Сразу после того, как ты установил новый индекс трека и запустил PlayCurrentTrackByIndex
            if (_uiManager != null)
            {
                _uiManager.TriggerNotification(); // Запускает таймер исчезновения
            }
